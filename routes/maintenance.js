...
router.post('/', (req, res) => {
  ...
  queryRun(
    ...
    [unit_id, tenant_id || null, title, description || null, priority]
  );
...
router.get('/:id/edit', (req, res) => {
  const request = queryGet('SELECT * FROM maintenance_requests WHERE id = ?', [req.params.id]);
...
router.post('/:id', (req, res) => {
  ...
  queryRun(
    ...
    [unit_id, tenant_id || null, title, description || null, priority, status, completed_at, req.params.id]
  );
...
router.post('/:id/delete', (req, res) => {
  queryRun('DELETE FROM maintenance_requests WHERE id = ?', [req.params.id]);
